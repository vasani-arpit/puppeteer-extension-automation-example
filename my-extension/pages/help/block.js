define(["exports"], function (_exports) {
  ...
  function _templateObject_fe361ff0226611eaa20e13a597e0dbb8() {
    ...
    _templateObject_fe361ff0226611eaa20e13a597e0dbb8 = function _templateObject_fe361ff0226611eaa20e13a597e0dbb8() {
      return data;
    };
  ...
  */
  ...
  /*: string*/
    ...
    return (
      /*: string*/
      string.split('-').map(function (part, index) {
        if (!index) return part;
        var start = part.slice(0, 1).toUpperCase();
        var end = part.slice(1);
        return start + end;
      }).join('')
    );
  };

  var verticalProperties = Object.freeze(['border-top-width', 'border-bottom-width', 'padding-top', 'padding-bottom', 'height']);
  ...
  /*: Object*/
  {
    ...
    if (direction === 'up') {
      ...
      keyframes = verticalProperties.reduce(function (carry, property) {
        carry[0][uppercase(property)] = style.getPropertyValue(property);
        carry[1][uppercase(property)] = 0;
        return carry;
      }, [{}, {}]);
      ...
      keyframes = verticalProperties.reduce(function (carry, property) {
        carry[0][uppercase(property)] = 0;
        carry[1][uppercase(property)] = _style2.getPropertyValue(property);
        return carry;
      }, [{}, {}]);
      element.style.cssText = verticalProperties.reduce(function (carry, property) {
                          ...
                          while (1) {
                            switch (_context2.prev = _context2.next) {
                              case 0:
                                ...
                                style = getComputedStyle(elements.information);
                                animation = elements.information.animate([{
                      ...
                      return regeneratorRuntime.wrap(function _callee3$(_context3) {
                        while (1) {
                          switch (_context3.prev = _context3.next) {
                            case 0:
                              animation = slide(currentObject.elements.information, currentObject.visible ? 'up' : 'down', {
                                'duration': 700,
                                'easing': 'linear'
                              });
                              _context3.next = 3;
